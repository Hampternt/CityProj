...
2026-08-17; pack 2 (the sim runs on metals) is executing on branch
`claude/multimetal-plan-project-f85924`
(`docs/manifests/2026-08-20-mmm-pack2-sim-on-metals.md`).*
